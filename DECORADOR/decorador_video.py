def funcion_decoradora(funcion_a_decorar):
    ...
    """ objeto
    El bloque de código dentro de funcion_interior es precisamente la lógica 
    adicional que se "inyecta" o se aplica a todas las funciones que decoras.
    """
    ...
    return funcion_interior# debe devolver el objeto
