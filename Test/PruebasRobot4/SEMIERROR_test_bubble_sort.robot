...
Library    Collections  # ¡Añade o descomenta esta línea!
...
Verificar Ordenamiento Bubble Sort
    ...
    # Obtener la longitud de la lista usando la palabra clave Get Length
    ${array_length}=    Get Length    ${initial_array}

    # Llama a la función bubble_sort de tu módulo Python
    # Ahora pasamos la longitud como una variable separada
    Bubble Sort    ${initial_array}    ${array_length}
...
Verificar Ordenamiento con Array Vacio
    ...
    ${empty_array_length}=    Get Length    ${empty_array} # Obtener la longitud
    Bubble Sort    ${empty_array}    ${empty_array_length} # Pasar la longitud
...
Verificar Ordenamiento con Array Ya Ordenado
    ...
    ${sorted_array_length}=    Get Length    ${sorted_array} # Obtener la longitud
    Bubble Sort    ${sorted_array}    ${sorted_array_length} # Pasar la longitud
