...
try:
    ...
    features_regresion = ['MedInc', 'HouseAge', 'AveRooms', 'AveBedrms', 'Population', 'AveOccup', 'Latitude',
                          'Longitude']
...
# --- PASO 7: FUNCIONES PARA LAS MÉTRICAS PERSONALIZADAS (RAE, RSE) ---
# Estas funciones se crean para replicar las fórmulas de RAE y RSE
...
# --- PASO 8: EVALUAR EL RENDIMIENTO DEL MODELO CON TODAS LAS MÉTRICAS ---
...
print(f"Error Absoluto Relativo (RAE): {rae:.2f}")

# RSE (Relative Squared Error)
rse = relative_squared_error(y_test, y_pred)
print(f"Error Cuadrático Relativo (RSE): {rse:.2f}")

# R-cuadrado (R-squared)
r2 = r2_score(y_test, y_pred)
print(f"Coeficiente de Determinación (R-cuadrado): {r2:.2f}")

# --- PASO 9: PREDECIR UN NUEVO VALOR (como la fila 9 de tu imagen) ---
...
# --- PASO 10: GUARDAR Y CARGAR EL MODELO (Opcional) ---
...
Paso 7: Evaluación de las Métricas

Se añaden funciones personalizadas para RAE y RSE.

Se calculan todas las métricas de rendimiento (MAE, MSE, RMSE, RAE, RSE, R-cuadrado) comparando las predicciones del modelo (y_pred) con los valores reales (y_test).
